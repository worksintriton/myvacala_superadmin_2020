...
@Component({
  selector: 'app-viewparkingbookinglist',
  templateUrl: './viewparkingbookinglist.component.html',
  styleUrls: ['./viewparkingbookinglist.component.scss']
})
export class ViewparkingbookinglistComponent implements OnInit {
