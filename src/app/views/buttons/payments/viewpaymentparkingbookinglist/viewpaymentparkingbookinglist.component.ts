...
@Component({
  selector: 'app-viewpaymentparkingbookinglist',
  templateUrl: './viewpaymentparkingbookinglist.component.html',
  styleUrls: ['./viewpaymentparkingbookinglist.component.scss']
})
export class ViewpaymentparkingbookinglistComponent implements OnInit {
