...
export class CouponCodeComponent implements OnInit {
  ...
  validation() {
    if ((this.Value_Type == "Percentage" ? (this.amount != undefined && this.amount != '') : true) && this.mainservice_id != undefined && this.VehicleType != undefined && (this.Coupon_Code != undefined && this.Coupon_Code != '') && this.Value_Type != undefined && this.Value != undefined && this.Value != '' && this.Description != undefined && this.Description != '' && this.Count != undefined && this.Count != '' && this.customers != undefined) {
      this.validate = true;
    }
  }
