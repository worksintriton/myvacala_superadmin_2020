...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.banneredit = function (data) {
    ...
    ApiService.prototype.editmainservice = function (data) {
        return this.http.put(this.apiUrl + 'service/edit', data);
    };
    ApiService.prototype.createmainservice = function (data) {
        return this.http.post(this.apiUrl + 'service/create', data);
    };
    ApiService.prototype.deletemainservice = function (data) {
        return this.http.post(this.apiUrl + 'service/delete', data);
    };
    ApiService.prototype.vehiclecreation = function (data) {
    ...
    ApiService.prototype.vehiclebrand = function () {
        return this.http.get(this.apiUrl + 'vehiclebrand/getlist');
    };
    ApiService.prototype.vehiclebrandcreation = function (data) {
        return this.http.post(this.apiUrl + 'vehiclebrand/create', data);
    };
    ApiService.prototype.vehiclebrand_delete = function (data) {
        return this.http.post(this.apiUrl + 'vehiclebrand/delete', data);
    };
    ApiService.prototype.vehicleBrandList = function (data) {
        return this.http.post(this.apiUrl + 'vehiclebrand/vehicletypegetlist', data);
    };
    ApiService.prototype.PopularvehicleList = function (data) {
    ...
    // } 
    ApiService.prototype.parking_bookingList = function () {
        return this.http.get(this.apiUrl + 'parking/getlist');
    };
    ApiService.prototype.slotList_save = function (data) {
        return this.http.post(this.apiUrl + 'parkingvendor/slotallocation', data);
    };
    ApiService.prototype.VehicleBrand_save = function (data) {
        return this.http.post(this.apiUrl + 'vehiclebrand/create', data);
    };
    ...
    // }
    ApiService.prototype.VehicleBrandEdit = function (data) {
        return this.http.put(this.apiUrl + 'vehiclebrand/edit', data);
    };
    ApiService.prototype.Employee_save = function (data) {
        return this.http.post(this.apiUrl + 'employee/create', data);
    };
    ApiService.prototype.Employee_list = function (data) {
    ...
    ApiService.prototype.faq_delete = function (data) {
        return this.http.post(this.apiUrl + 'faq/delete', data);
    };
    ApiService.prototype.faqcreate = function (data) {
        return this.http.post(this.apiUrl + 'faq/create', data);
    };
    ApiService.prototype.banner = function (data) {
        return this.http.post(this.apiUrl + 'homebanner/create', data);
    };
    ApiService.prototype.bannerlist = function () {
        return this.http.get(this.apiUrl + 'homebanner/getlist');
    };
    ApiService.prototype.mainservicebanner = function (data) {
        return this.http.post(this.apiUrl + 'servicebanner/create', data);
    };
    ApiService.prototype.mainservicebanneredit = function (data) {
        return this.http.post(this.apiUrl + 'servicebanner/edit', data);
    };
    ApiService.prototype.mainservicebannerdelete = function (data) {
        return this.http.post(this.apiUrl + 'servicebanner/delete', data);
    };
    ApiService.prototype.maniservicebannerlist = function () {
        return this.http.get(this.apiUrl + 'servicebanner/admin/getlist');
    };
    ApiService.prototype.getmaniservicebannerlist = function (data) {
        return this.http.post(this.apiUrl + 'servicebanner/admin/mastergetlist', data);
    };
    ApiService.prototype.flash = function (data) {
        return this.http.post(this.apiUrl + 'mobilesplashscreen/create', data);
    };
    ApiService.prototype.flash_list = function () {
        return this.http.get(this.apiUrl + 'mobilesplashscreen/getlist');
    };
    ApiService.prototype.flash_edit = function (data) {
        return this.http.put(this.apiUrl + 'mobilesplashscreen/edit', data);
    };
    ApiService.prototype.flashscreenDelete = function (data) {
    ...
    ApiService.prototype.popular_service_get_daetails = function () {
        return this.http.get(this.apiUrl + 'mobileappdetails/getlist');
    };
    ApiService.prototype.emp_edit = function (data) {
        return this.http.post(this.apiUrl + 'employee/edit', data);
    };
    ApiService.prototype.popular_service_edit = function (data) {
    ...
    ApiService.prototype.Parking_owner_checking_Get_Id = function (data) {
    ...
    ApiService.prototype.user_delete = function (data) {
...
/* harmony import */ var _views_buttons_otplogin_otplogin_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./views/buttons/otplogin/otplogin.component */ "./src/app/views/buttons/otplogin/otplogin.component.ts");
/* harmony import */ var _views_buttons_otpvalidation_otpvalidation_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./views/buttons/otpvalidation/otpvalidation.component */ "./src/app/views/buttons/otpvalidation/otpvalidation.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            declarations: [
                ...
                _views_buttons_otplogin_otplogin_component__WEBPACK_IMPORTED_MODULE_6__["OtploginComponent"],
                _views_buttons_otpvalidation_otpvalidation_component__WEBPACK_IMPORTED_MODULE_7__["OtpvalidationComponent"]
            ]),
            providers: [{
...
/* harmony import */ var _views_buttons_otplogin_otplogin_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./views/buttons/otplogin/otplogin.component */ "./src/app/views/buttons/otplogin/otplogin.component.ts");
/* harmony import */ var _views_buttons_otpvalidation_otpvalidation_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./views/buttons/otpvalidation/otpvalidation.component */ "./src/app/views/buttons/otpvalidation/otpvalidation.component.ts");
...
var routes = [
    ...
    {
        path: 'EmployeeLogin',
        component: _views_buttons_otplogin_otplogin_component__WEBPACK_IMPORTED_MODULE_8__["OtploginComponent"],
        data: {
            title: 'Brand buttons'
        }
    },
    {
        path: 'OtpValidation',
        component: _views_buttons_otpvalidation_otpvalidation_component__WEBPACK_IMPORTED_MODULE_9__["OtpvalidationComponent"],
        data: {
            title: 'Brand buttons'
        }
    },
...
/***/ "./src/app/containers/default-layout/default-layout.css":
/*!**************************************************************!*\
  !*** ./src/app/containers/default-layout/default-layout.css ***!
  \**************************************************************/
/*! no static exports found */
...
module.exports = ":host::ng-deep .sidebar-fixed .sidebar {\r\n    width: 250px !important;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".login_box {\n  position: relative;\n  top: 0px;\n  width: 100%;\n  height: 100vh;\n  max-height: 100vh;\n  text-align: center;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background-color: #f1f1f1;\n  background-image: url('Professional-Car-Mechanic.jpg');\n  background-repeat: no-repeat;\n  background-size: cover;\n  background-position: center;\n}\n\n.login_box_inner {\n  display: contents;\n  background-color: #fff;\n  padding: 50px;\n  border-radius: 8px;\n  box-shadow: 0px 0px 10px 0px #dadada;\n}\n\n.form-control {\n  border: 1px solid #323b92;\n}\n\n.login_form {\n  margin: 10px 0px;\n}\n\n.card .card-body {\n  text-align: left !important;\n}\n\n.form-control {\n  width: 300px !important;\n}\n\n.logo img {\n  margin: 0px 0px 24px 32%;\n  width: 100px;\n}\n\n.justify-center {\n  display: flex;\n  justify-content: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var OtploginComponent = /** @class */ (function () {
    function OtploginComponent(router, http, _api, storage) {
        this.router = router;
        this.http = http;
        this._api = _api;
    ...
    OtploginComponent.prototype.loginotp = function () {
        var _this = this;
        if (this.phonenumber === '') {
            this.phError = true;
        ...
        this._api.otploginprocess(data).subscribe(function (response) {
    ...
    OtploginComponent.prototype.saveInLocal = function (key, val) {
        this.storage.set(key, val);
    };
    OtploginComponent.prototype.getFromLocal = function (key) {
    ...
    OtploginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](3, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(ngx_webstorage_service__WEBPACK_IMPORTED_MODULE_4__["SESSION_STORAGE"])),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"],
            _api_service__WEBPACK_IMPORTED_MODULE_5__["ApiService"], Object])
    ], OtploginComponent);
...
module.exports = ".login_box {\n  position: relative;\n  top: 0px;\n  width: 100%;\n  height: 100vh;\n  max-height: 100vh;\n  text-align: center;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background-color: #f1f1f1;\n  background-image: url('hiring-Mobile-Mechanics.jpg');\n  background-repeat: no-repeat;\n  background-size: cover;\n  background-position: center;\n}\n\n.login_box_inner {\n  display: contents;\n  background-color: #fff;\n  padding: 50px;\n  border-radius: 8px;\n  box-shadow: 0px 0px 10px 0px #dadada;\n}\n\n.form-control {\n  border: 1px solid #323b92;\n}\n\n.login_form {\n  margin: 10px 0px;\n}\n\n.card .card-body {\n  text-align: left !important;\n}\n\n.form-control {\n  width: 300px !important;\n}\n\n.logo img {\n  margin: 0px 0px 24px 32%;\n  width: 100px;\n}\n\n.justify-center {\n  display: flex;\n  justify-content: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".login_box {\n  position: relative;\n  top: 0px;\n  width: 100%;\n  height: 100vh;\n  max-height: 100vh;\n  text-align: center;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background-color: #f1f1f1;\n  background-image: url('hiring-Mobile-Mechanics.jpg');\n  background-repeat: no-repeat;\n  background-size: cover;\n  background-position: center;\n}\n\n.login_box_inner {\n  display: contents;\n  background-color: #fff;\n  padding: 50px;\n  border-radius: 8px;\n  box-shadow: 0px 0px 10px 0px #dadada;\n}\n\n.form-control {\n  border: 1px solid #323b92;\n}\n\n.login_form {\n  margin: 10px 0px;\n}\n\n.card .card-body {\n  text-align: left !important;\n}\n\n.form-control {\n  width: 300px !important;\n}\n\n.logo img {\n  margin: 0px 0px 24px 32%;\n  width: 100px;\n}\n\n.justify-center {\n  display: flex;\n  justify-content: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.addfiles1 = function () {
        var _this = this;
        var fd = new FormData();
...
module.exports = __webpack_require__(/*! D:\MY_OFFICE\myvacala_superadmin_2020\src\main.ts */"./src/main.ts");
