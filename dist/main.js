...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.parkLocationList = function () {
        return this.http.get(this.apiUrl + 'parkinglocation/admin/getlist');
    };
    ApiService.prototype.parkLocationSave = function (data) {
        return this.http.post(this.apiUrl + 'parkinglocation/create', data);
    };
    ApiService.prototype.parkLocationDelete = function (data) {
        return this.http.post(this.apiUrl + 'parkinglocation/delete', data);
    };
    ApiService.prototype.parkLocationEdit = function (data) {
